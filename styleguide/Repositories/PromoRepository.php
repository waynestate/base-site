    ...
    public function getRequestData(array &$data)
    {
        ...
        */
        ...
        $hero_page_ids = [
            ...
            // Rotate carousel
            105100104 => app(HeroImageRotate::class)->create(6, false),
            // Text overlay
            ...
            105100109 => app(HeroImage::class)->create(1, false, [
                ...
                'relative_url' => '/styleguide/image/1600x900?text=Split',
            ]),
            // Childpage
            101100 => app(HeroImage::class)->create(1, false),
            // Layout small banner hero
            105100108 => app(HeroImage::class)->create(1, false, [
                'option' => 'Banner slim full',
                'relative_url' => '/styleguide/image/3200x600?text=Slim+banner+hero+image',
            ]),
            ...
            105100113 => app(HeroImage::class)->create(1, false, [
                'option' => 'SVG contained',
                'title' => 'Contained SVG overlay',
            ...
            105100114 => app(HeroImage::class)->create(1, false, [
                'option' => 'Logo contained',
                'title' => 'Contained logo overlay',
