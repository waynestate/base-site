        ...
        */
        ...
        $hero_page_ids = [
            ...
            105100107 => app(HeroImage::class)->create(1, false, [
                'option' => 'Logo Overlay full-width',
            ...
            // Contained text overlay
            105100112 => app(HeroImage::class)->create(1, false, [
                'option' => 'Text overlay contained',
                'relative_url' => '/styleguide/image/1600x580?text=Contained+text+overlay',
            ]),
            // Contained SVG overlay
            105100113 => app(HeroImage::class)->create(1, false, [
                'option' => 'SVG overlay contained',
                'relative_url' => '/styleguide/image/1600x580?text=Contained+SVG+overlay',
                'secondary_relative_url' => 'data:image/svg+xml;base64,',
            ]),
            // Contained logo overlay
            105100114 => app(HeroImage::class)->create(1, false, [
                'option' => 'Logo overlay contained',
                'relative_url' => '/styleguide/image/1600x580?text=Contained+logo+overlay',
                'secondary_relative_url' => '/styleguide/image/600x250?text=Secondary+image',
            ]),
        ];
