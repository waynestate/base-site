        ...
        return app(PageFactory::class)->create(1, true, [
            'page' => [
                ...
                'content' => [
                    ...
                    <ul><li>"Spotlight" <code class="bg-gray-200 py-1 px-2 rounded-sm text-sm">php artisan base:module spotlight</code></li>
                    <li>"Expanding Grid" <code class="bg-gray-200 py-1 px-2 rounded-sm text-sm">php artisan base:module expanding-grid</code></li></ul>
