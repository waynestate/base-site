                            ...
                            <li>
                                ...
                                <div class="content">
                                    <ul>
                                        ...
                                        <li>Paste this JSON array into the page field and edit the values:<br />
...
"showDescription":"true",
                                        ...
                                        <li><strong>ID:</strong> Promo group ID is the only required parameter.</li>
                                        <li><strong>Config:</strong> Promo group config passed to the API, pipe delimited. Page ID is programatically assigned if \'page_id\' is used. Optional.</li>
                                        <li><strong>Columns:</strong> 2, 3, or 4; default is 1, not required.</li>
                                        <li><strong>Single promo view:</strong> true/false; create a CMS page titled "Promo view", with the url "view". Not required.</li>
                                    </ul>
                                </div>
                            </li>
                            <li>
