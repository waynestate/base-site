...
class MenuRepositoryTest extends TestCase
{
    ...
    public function menu_api_error_should_throw_exception()
    {
        ...
        // Get the menus
        $menus = $this->app->build('Styleguide\Repositories\MenuRepository', [$wsuApi])->getAllMenus($this->faker->randomDigit);
    }
    ...
    public function getting_a_menu_without_menu_items_should_not_error()
    {
        ...
        $menus = app('Styleguide\Repositories\MenuRepository', [$wsuApi])->getAllMenus($data['site']['id'], $data['site']['parent']['id'], $data['menu']['id']);
    ...
    public function getting_all_menus_should_return_array_of_menus()
    {
        ...
        // Get all the menus
        $menus = app('App\Repositories\MenuRepository', [$wsuApi])->getRequestData($page);
