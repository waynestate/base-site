...
class NewsRepositoryTest extends TestCase
{
    ...
    public function getting_news_categories_should_return_news_categories()
    {
        ...
        $categories = $this->app->build('App\Repositories\NewsRepository', [$wsuApi])->getCategories($this->faker->randomDigit);
    ...
    public function getting_news_item_should_return_news_item()
    {
        ...
        // Get the news categories
        $news = $this->app->build('App\Repositories\NewsRepository', [$wsuApi])->getNewsItem($this->faker->randomDigit, $this->faker->randomDigit);
    ...
    public function getting_news_by_display_order_with_api_error_should_return_array()
    {
        ...
        // Get the news
        $news = $this->app->build('App\Repositories\NewsRepository', [$wsuApi])->getNewsByDisplayOrder($this->faker->randomDigit);
    ...
    public function getting_news_by_page_should_return_array_of_news()
    {
        ...
        // Get the news
        $news = $this->app->build('App\Repositories\NewsRepository', [$wsuApi])->getNewsByPage($this->faker->randomDigit);
