...
class DataMiddlewareTest extends TestCase
{
    ...
    public function data_middleware_should_run_successfully()
    {
        ...
        app('Styleguide\Http\Middleware\DataMiddleware')->handle($request, function ($response) {
            // Controller check
    ...
    public function controller_namespace_should_return_string()
    {
        ...
        $this->assertTrue(is_string(app('Styleguide\Http\Middleware\DataMiddleware')->getControllerNamespace('StyleGuideController')));
        ...
        $namespace = app('Styleguide\Http\Middleware\DataMiddleware')->getControllerNamespace($controller);
