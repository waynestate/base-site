...
<a href="{{ $profile['link'] }}" class="group">
    <div class="aspect-portrait mb-1">
        @image(!empty($profile['data']['Picture']['url']) ? $profile['data']['Picture']['url'] : Vite::asset('/resources/images/no-photo.svg'), $profile['data']['First Name'].' '.$profile['data']['Last Name'], 'h-full w-full object-cover object-center')
    </div>
