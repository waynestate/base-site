...
<div class="row relative">
    <a class="banner bg-yellow items-center justify-center absolute pin-r mr-8 transition transition-timing-ease-out hover:text-black hidden mt:flex z-5" href="{{ $banner['link'] }}">
