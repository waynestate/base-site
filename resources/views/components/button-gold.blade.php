...
@if(!empty($button['link']))
    <a href="{{ $button['link'] }}" class="gold-gradient-button @if(!empty($button['excerpt']) || !empty($button['relative_url']) || !empty($button['secondary_relative_url']))two-line-button @endif {{ $class ?? '' }}">
