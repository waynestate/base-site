...
@if(!empty($button['link']))
    <a href="{{ $button['link'] }}" class="green-button @if(!empty($button['excerpt']) || !empty($button['relative_url']) || !empty($button['secondary_relative_url']))button--two-line @endif {{ $class ?? '' }}">
