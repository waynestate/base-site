    ...
    <body>
            ...
            <div class="wsuwrap">
                <div class="wsuwordmark">
                    <h1>
                        <a href="https://wayne.edu/" aria-labelledby="wsuheader-title">
                            <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 605 65" preserveAspectRatio="xMaxYMin meet">
                ...
                <div class="wsumenu">
                    <a class="warriorstrong" href="https://wayne.edu/warriorstrong/" aria-labelledby="wsuheader-brand">
                        <svg xmlns="https://www.w3.org/2000/svg" viewBox="0 0 380 30"  preserveAspectRatio="xMaxYMax">
        ...
        <main class="row">
            <div class="content center-site">
                <div id="content" class="xlarge-offset-1 xlarge-5 large-6 medium-12 small-12 columns" tabindex="-1">
                    <h1>403</h1>
                    ...
                    additional help, please email us at <a href="mailto:web@wayne.edu">web@wayne.edu</a> and we will
                    try to assist you.</p>
                </div>
                <div class="xlarge-6 large-6 medium-12 small-12 columns">
                    <div class="forbidden-graphic"></div>
                </div>
            </div>
        </main>
