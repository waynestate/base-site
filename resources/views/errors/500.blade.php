        ...
        <main class="center-site">
            <div class="row">
                <div id="content" class="content xlarge-offset-1 large-6 xlarge-5 columns" tabindex="-1">
                    ...
                    <p>We track these errors automatically, but if the<br /> problem persists feel free to <a href="mailto:web@wayne.edu">contact us</a>.<br /> In the meantime, try <a href="//">refreshing</a>.</p>
                </div>
